export const en = {
  ...
  hero: {
    ...
    title: "Fullstack Dev",
    subtitle:
      "I build robust APIs, web systems, and solutions that actually work in production.",
    cta: "View projects",
  ...
  about: {
    ...
    badge: "// who I am",
    text1:
      "I'm a developer from Pinhais, Brazil, passionate about clean code and well-architected systems. I started on the back-end with C# and .NET, and expanded into the front-end world with React and Next.js — giving me a complete picture of what I build.",
    text2:
    ...
    facts: [
      ...
      { label: "Current focus", value: "React & Next.js" },
    ...
    items: [
      {
        ...
        description:
          "Building robust APIs with C# and .NET, following DDD and Clean Architecture best practices.",
        icon: "Server",
      },
      {
        title: "Fullstack Web Systems",
        description:
          "From database to front-end. React and Next.js on the client, .NET or Node on the server.",
        icon: "Monitor",
      },
      {
        title: "Databases",
        description:
          "Modeling and optimization with SQL Server, PostgreSQL, and MongoDB. Migrations, queries and integrations.",
        icon: "Database",
      },
      {
        title: "Automations & Integrations",
        description:
          "Scripts, scheduled tasks, and system integrations via API or message brokers.",
        icon: "Zap",
      },
    ],
  },
  ...
  skills: {
    ...
    badge: "// tech stack",
    categories: [
      { name: "Languages", skills: ["C#", "SQL", "JavaScript", "TypeScript"] },
      {
        name: "Frameworks",
  ...
  learning: {
    ...
    items: [
      { name: "React", progress: 65, description: "Components, hooks, state management and advanced patterns" },
      { name: "Next.js 16", progress: 50, description: "App Router, Server Components and Vercel deployment" },
      { name: "TypeScript", progress: 60, description: "Advanced typing, generics and best practices" },
      { name: "Clean Architecture (.NET)", progress: 70, description: "Deepening into DDD and separation of concerns" },
    ],
  },
  contact: {
    title: "Let's talk",
