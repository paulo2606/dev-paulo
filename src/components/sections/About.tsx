...
export default function About() {
  ...
  return (
    <section id="about" className="min-h-screen md:h-screen md:overflow-hidden pt-20 md:pt-24 pb-16 md:pb-0 px-6 md:px-14 border-t border-[var(--border)] flex flex-col justify-center">
